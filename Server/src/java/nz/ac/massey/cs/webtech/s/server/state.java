    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session == null) {
            ...
            for (String[] gameState1 : gameState) {
                for (int j = 0; j < gameState1.length; j++) {
                    if (gameState1[j].equals("")) {
                        gameState1[j] = "_";
                    }
                }
            }
            ...
            // If client request txt format or does not request a format 
            } else {
